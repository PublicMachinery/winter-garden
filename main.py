...
speckleToken="88dcf02041c4c28835ee56041a1194aa965edeb399" #tokenCol.text_input("Speckle token","Please enter your token here", help="If you don't know how to get your token, take a look at this [link](<https://speckle.guide/dev/tokens.html>)👈")
...
with viewer2:
    ...
    speckleCol._iframe(commit2viewer)
